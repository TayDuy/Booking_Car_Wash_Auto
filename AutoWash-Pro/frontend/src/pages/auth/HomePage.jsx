    ...
    <div className="home-container">
      ...
      <section className="hero-split-container">
        <div className="hero-left-block">
          ...
          <p className="hero-sub-text">
            ...
            Nhanh chóng, an toàn tuyệt đối cho bề mặt sơn
      ...
      <section className="services-showcase-container">
        <div className="services-section-title">
          ...
          <p>
            Lựa chọn gói chăm sóc phù hợp với nhu cầu của xế yêu.
          </p>
        </div>
        ...
        <div className="services-flex-grid">
          {services.map((item, index) => (
            ...
            >
              {item.isPopular && (
                <span className="popular-top-tag">
                  Phổ biến
                </span>
              )}

              <div
                className={`service-icon-box ${item.iconClass}`}
              >
                {item.icon}
              </div>
              ...
              <div className="service-card-bottom">
                ...
                <button className="service-detail-link">
                  Chi tiết
                </button>
              </div>
            </div>
