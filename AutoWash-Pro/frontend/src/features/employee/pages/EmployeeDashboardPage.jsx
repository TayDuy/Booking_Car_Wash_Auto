...
import { EMPLOYEE_BOOKING_STATUS } from "../constants/employeeBookingStatus";
            ...
            {recentBookings.map((booking) => (
              ...
              >
                ...
                {(() => {
                  ...
                  return <span className="dashboard-payment-badge dashboard-payment-unpaid">Chưa thanh toán</span>;
                })()}
              </article>
            ))}
          </div>
