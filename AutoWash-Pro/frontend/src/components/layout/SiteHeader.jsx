  ...
  return (
      <header className="custom-app-header">
        ...
        <nav className="header-navigation">
          {isLoggedIn ? (
            ...
            <>
              ...
              <button
                  className={isActive("/support") || isActive("/customer/support") ? "active-link" : ""}
        ...
        <div className="header-actions-group">
          {!isLoggedIn ? (
            <>
              <button className="site-login-btn" onClick={() => navigate("/auth/login")}>
                Đăng nhập
              </button>
              <button className="site-register-btn" onClick={() => navigate("/auth/register")}>
                Đăng ký
              </button>
            </>
          ) : (
